...
def LinearCurve(positions, t, screen, color, trigger=True):
    ...
    if trigger == True:
        pygame.draw.line(screen, (0, 0, 0), (positions[0].x, positions[0].y), (positions[1].x, positions[1].y), 2)
...
def QuadraticCurve(positions, t, screen, color, curve_list, green, trigger= True):
    ...
    if trigger == True:
        pygame.draw.line(screen, (0, 0, 0), (positions[0].x, positions[0].y), (positions[1].x, positions[1].y), 2)
        pygame.draw.line(screen, (0, 0, 0), (positions[1].x, positions[1].y), (positions[2].x, positions[2].y), 2)
        ...
        pygame.draw.line(screen, green, a, b, 4)
        pygame.draw.circle(screen, color, (int(curve[0]), int(curve[1])), 8)
...
def CubicCurve(positions, t, screen, color, curve_list, green, blue, quad_curve, quad_curve1, quad_curve2):
    ...
    pygame.draw.line(screen, (0, 0, 0), (positions[0].x, positions[0].y), (positions[1].x, positions[1].y), 2)
    pygame.draw.line(screen, (0, 0, 0), (positions[1].x, positions[1].y), (positions[2].x, positions[2].y), 2)
    pygame.draw.line(screen, (0, 0, 0), (positions[2].x, positions[2].y), (positions[3].x, positions[3].y), 2)
    ...
    pygame.draw.line(screen, green, a, b, 3)
    pygame.draw.line(screen, green, b, c, 3)
